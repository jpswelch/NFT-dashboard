                ...
                <div className="title-cont">
                  ...
                  <table className="collection-table">
                    <tr className="title-row" style={{ color: light }}>
                      ...
                      <td># of owners</td>
                      <td>Show love to your supporters!</td>
                    </tr>
                    <tr className="data-row">
                      ...
                      <td>
                        {ownerAddressArray?.length > 0
                          ? ownerAddressArray?.length
                          : "n/a"}
                      </td>
                      <td>
                        <GiftModal
            ...
            {activeLoader ? (
              ...
              <div className="collection-display">
                <div
                  ...
                  onClick={() => {
                    history.push(
                      `/nft/${collectionData[0]?.collection_address}/${collectionData[0]?.first_nft_image_token_id}/${collectionData[0].chain_id}`
                    );
                  }}
                >
                  <img
                ...
                <div
                  ...
                  onClick={() => {
                    history.push(
                      `/nft/${collectionData[0]?.collection_address}/${collectionData[0]?.second_nft_image_token_id}/${collectionData[0].chain_id}`
                    );
                  }}
                >
                  <img
                    src={collectionData[0]?.second_nft_image_256}
                    alt="No preview available"
                  />
                </div>
                <div
                  ...
                  onClick={() => {
                    history.push(
                      `/nft/${collectionData[0]?.collection_address}/${collectionData[0]?.third_nft_image_token_id}/${collectionData[0].chain_id}`
                    );
                  }}
                >
                  <img
                    src={collectionData[0]?.third_nft_image_256}
                    alt="No preview available"
                  />
                </div>
                <div
                  ...
                  onClick={() => {
                    history.push(
                      `/nft/${collectionData[0]?.collection_address}/${collectionData[0]?.fourth_nft_image_token_id}/${collectionData[0].chain_id}`
                    );
                  }}
                >
                  <img
                    src={collectionData[0]?.fourth_nft_image_256}
                    alt="No preview available"
                  />
                </div>
                <div
                  ...
                  onClick={() => {
                    history.push(
                      `/nft/${collectionData[0]?.collection_address}/${collectionData[0]?.fifth_nft_image_token_id}/${collectionData[0].chain_id}`
                    );
                  }}
                >
                  <img
                    src={collectionData[0]?.fifth_nft_image_256}
                    alt="No preview available"
                  />
                </div>
              </div>
